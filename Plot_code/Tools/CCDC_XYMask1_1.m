function [clrx,clry,idgood, cloudy_x, cloudy_y, shadow_x, shadow_y,...
...
cloudy_x=sdate(line_m==4);
cloudy_y=line_t(line_m==4);

shadow_x=sdate(line_m==2);
shadow_y=line_t(line_m==2);

snow_x=sdate(line_m==3);
snow_y=line_t(line_m==3);
